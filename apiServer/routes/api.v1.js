...
module.exports.apiV1 =  function (app) {
  ...
  //farm api
  router.post('/farms/create',[isLoggedIn(),admin()].concat(farmCreationValidator()),(req,res)=>{farm.create(req,res)});
  ...
  router.post('/farms/activities/create',[isLoggedIn(),admin()].concat(farmActivityValidator()),(req,res)=>{farm.activity(req,res)});
